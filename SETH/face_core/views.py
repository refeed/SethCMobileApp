...
def add_face(request):
    ...
    if len(camera_avail)>0:
        ...
        try:
            ...
            msg = 'Face Core not ready yet'
            print(msg)
            return HttpResponseNotFound(msg)
        return render(request, 'front1/faceRecog.html', {'face_code': camera_id, 'token_id': the_token})
    else:
        return render(request, 'front1/faceRecog.html', {'face_code': -1})
