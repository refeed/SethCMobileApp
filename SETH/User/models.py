...
#     aplace = models.ForeignKey(SETHModels.APlace, on_delete=models.CASCADE, related_name='auser')
...
#     username = models.CharField(_('username'), blank=True, unique=True, max_length=30, )
#     password = models.CharField(_('password'), max_length=30)
#     bplace = models.ForeignKey(SETHModels.BPlace, on_delete=models.CASCADE, related_name='buser')
